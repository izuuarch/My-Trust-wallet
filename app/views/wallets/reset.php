...
<div class="page-wrapper">
    ...
    {
      echo '<h4 style="color: red;">'.$_SESSION['passerror'].'</h4>';
      unset($_SESSION['passerror']);
          } 
          ?>
                            <form action="<?= BASEURL; ?>/reset" method="post">
                            <input type="hidden" name="hiddentoken" value="<?php echo $data['token']?>">
                            <div class="form-group">
                                    <label>New Password</label>
                                    <input class="au-input au-input--full" type="password" name="newpassword" id="password" required>
                                </div>
                                <div class="form-group">
                                    <label>Confirm Password</label>
                                    <input class="au-input au-input--full" type="password" name="newcompassword" id="password" required>
                                </div>
                                <button class="au-btn au-btn--block au-btn--green m-b-20" name="newpwdbtn" type="submit" style="background: black; color:white;">Done</button>
                            </form>
                        </div>
                    </div>
                </div>
